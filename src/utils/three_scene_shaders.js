...
export const testLineFS2 = `
    uniform sampler2D colorTexture; // 颜色纹理
    varying float vProgress;
    uniform float time;
    
    void main() {
        vec2 animatedTexCoord = vec2(fract(vProgress - time), 0.5);
...
export const dash_line_flow_fs = `
    uniform float time;
    varying float vT;
    void main() {
...
export const dash_line_flow_vs1 = `
    varying float vT;
    void main() {
        vT = position.x;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
export const dash_line_flow_fs1 = `
    uniform float time;
...
export const dash_line_flow_vs2 = `
    varying float vT;
    void main() {
        vT = position.y;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
export const dash_line_flow_fs2 = `
    uniform float time;
    uniform float line_len;
    varying float vT;
    void main() {
...
export const green_wire_frame_mesh_vs1 = `
            varying vec2 vUv;
            varying vec3 vWorldPosition;
            void main() {
                vUv = uv;
...
export const green_wire_frame_mesh_fs1 = `
            uniform vec3 circleCenter;
            uniform float circleRadius;
            varying vec3 vWorldPosition;
...
export const click_triangle_vs1 = `
            varying vec2 vUv;
            varying vec3 vWorldPosition;
            void main() {
                vUv = uv;
...
export const click_triangle_fs1 = `
